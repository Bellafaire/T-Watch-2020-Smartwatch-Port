/* Generic buttons stored in structs, this file allows the software to:
 *  • check presses
 *  • draw buttons with text or icons 
 */

//buttons used generally in the UI
PROGMEM iconButton homeButton = {SCREEN_WIDTH - 48, SCREEN_HEIGHT-48, 48, 48, INTERFACE_COLOR, BACKGROUND_COLOR, {(0b00000000 << 8) | 0b00000000, (0b00000000 << 8) | 0b00000000, (0b00000001 << 8) | 0b10000000, (0b00000011 << 8) | 0b11000000, (0b00000111 << 8) | 0b11100000, (0b00001111 << 8) | 0b11110000, (0b00111111 << 8) | 0b11111100, (0b01111111 << 8) | 0b11111110, (0b11111111 << 8) | 0b11111111, (0b00111111 << 8) | 0b11111100, (0b00111110 << 8) | 0b00111100, (0b00111110 << 8) | 0b00111100, (0b00111110 << 8) | 0b00111100, (0b00111110 << 8) | 0b00111100, (0b00111110 << 8) | 0b00111100, (0b00000000 << 8) | 0b00000000}};
PROGMEM iconButton homeNotificationsButton = {SCREEN_WIDTH - 48, SCREEN_HEIGHT - 48 * 2, 48, 48, INTERFACE_COLOR, BACKGROUND_COLOR, {(0b00100001 << 8) | 0b10000100, (0b01000111 << 8) | 0b11100010, (0b10001100 << 8) | 0b00110001, (0b10011000 << 8) | 0b00011001, (0b10010000 << 8) | 0b00001001, (0b00110000 << 8) | 0b00001100, (0b00110000 << 8) | 0b00001100, (0b00110000 << 8) | 0b00001100, (0b00110000 << 8) | 0b00001100, (0b00110000 << 8) | 0b00001100, (0b00100000 << 8) | 0b00000100, (0b01100000 << 8) | 0b00000110, (0b11000000 << 8) | 0b00000011, (0b11000000 << 8) | 0b00000011, (0b11111111 << 8) | 0b11111111, (0b00000011 << 8) | 0b11000000}};
...
PROGMEM iconButton homeAppsButton = {SCREEN_WIDTH - 48, SCREEN_HEIGHT - 48, 48, 48, INTERFACE_COLOR, BACKGROUND_COLOR, {    (0b00000000 << 8) | 0b00000000,    (0b01111011 << 8) | 0b11011110,    (0b01111011 << 8) | 0b11011110,    (0b01111011 << 8) | 0b11011110,    (0b01111011 << 8) | 0b11011110,    (0b00000000 << 8) | 0b00000000,    (0b01111011 << 8) | 0b11011110,    (0b01111011 << 8) | 0b11011110,    (0b01111011 << 8) | 0b11011110,    (0b01111011 << 8) | 0b11011110,    (0b00000000 << 8) | 0b00000000,    (0b01111011 << 8) | 0b11011110,    (0b01111011 << 8) | 0b11011110,    (0b01111011 << 8) | 0b11011110,    (0b01111011 << 8) | 0b11011110,    (0b00000000 << 8) | 0b00000000,  }};
